...
7.Тестирование на продуктивных данных в системе разработки завершено. Можно нести в BWP.
...
HANA. Это, с одной стороны, позволит избежать OOM-ошибок в вашей выгрузке, но может привести к OOM-ошибкам в других процессах, если (и только если)
